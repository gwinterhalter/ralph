...
check "gmail_smtp reads primary_env_vars.smtp_user"        "grep -q \"primary_env_vars.smtp_user\" '$NOTIFY'"
check "gmail_smtp reads primary_env_vars.smtp_app_password" "grep -q \"primary_env_vars.smtp_app_password\" '$NOTIFY'"
check "gmail_smtp reads primary_env_vars.to_address"        "grep -q \"primary_env_vars.to_address\" '$NOTIFY'"
